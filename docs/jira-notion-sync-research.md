...
3. Попробовать **скоупированный** токен (`read:jira-work`, `read:jira-user`, `read/write/delete:webhook:jira`) — если Notion его примет, это снизит риск от хранимого у Notion токена.
...
- Принимает ли Notion Jira Sync скоупированный токен (`read:jira-work`, `read:jira-user`, `read/write/delete:webhook:jira`) вместо scopeless.
